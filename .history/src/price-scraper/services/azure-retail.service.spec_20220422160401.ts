...
describe('AzureRetailService', () => {
  ...
  it('should save to DB and not write to file system or st fetching data from service that returns only one page and Config enabled to wirte to file/store ', () => {
    jest
      .spyOn(httpService, 'get')
      .mockImplementation(() => of(resultFromLastPage));
    jest.spyOn(fs, 'writeFile');
