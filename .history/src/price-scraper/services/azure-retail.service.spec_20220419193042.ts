...
describe('AzureRetailService', () => {
  ...
  it('should write files to directory on fetching data from service that returns with only one page ', () => {
    jest
  ...
  it('should write files to directory on fetching data from service with only one page ', () => {
    jest
      .spyOn(httpService, 'get')
      .mockImplementation(() => of(resultFromLastPage));
    jest.spyOn(fs, 'writeFile');
